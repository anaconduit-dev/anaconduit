...
class StatsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetStatsOnlineIpList = channel.unary_unary(
                ...
                request_serializer=stats__pb2.GetStatsRequest.SerializeToString,
                response_deserializer=stats__pb2.GetStatsOnlineIpListResponse.FromString,
                _registered_method=True)
        self.GetAllOnlineUsers = channel.unary_unary(
                '/xray.app.stats.command.StatsService/GetAllOnlineUsers',
                request_serializer=stats__pb2.GetAllOnlineUsersRequest.SerializeToString,
                response_deserializer=stats__pb2.GetAllOnlineUsersResponse.FromString,
                _registered_method=True)
...
def add_StatsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetStatsOnlineIpList': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=stats__pb2.GetStatsRequest.FromString,
                    response_serializer=stats__pb2.GetStatsOnlineIpListResponse.SerializeToString,
            ),
            'GetAllOnlineUsers': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAllOnlineUsers,
                    request_deserializer=stats__pb2.GetAllOnlineUsersRequest.FromString,
                    response_serializer=stats__pb2.GetAllOnlineUsersResponse.SerializeToString,
            ),
    }
...
class StatsService(object):
    ...
    def GetStatsOnlineIpList(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/xray.app.stats.command.StatsService/GetStatsOnlineIpList',
            stats__pb2.GetStatsRequest.SerializeToString,
            stats__pb2.GetStatsOnlineIpListResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetAllOnlineUsers(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/xray.app.stats.command.StatsService/GetAllOnlineUsers',
            stats__pb2.GetAllOnlineUsersRequest.SerializeToString,
            stats__pb2.GetAllOnlineUsersResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
